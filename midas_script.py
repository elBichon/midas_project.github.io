...
if __name__ == "__main__":
	...
	while True:
		...
		volume = df.volume.values.tolist()
		label = df.label.values.tolist()#(time in hours and minutes)
		...
		df_dict = {'index':df.index.values.tolist(),'date':df.date.values.tolist(),'volume':volume,'close':df.close.values.tolist(),'fft_20_close': df.fft_20_close.values.tolist(),'fft_20_open': df.fft_20_open.values.tolist(),'fft_20_low': df.fft_20_low.values.tolist(),'fft_20_high': df.fft_20_high.values.tolist(),'fft_100_close': df.fft_100_close.values.tolist(),'fft_100_low': df.fft_100_low.values.tolist(),'fft_100_high': df.fft_100_high.values.tolist(),'fft_100_open': df.fft_100_open.values.tolist(),'fft_100_close': df.fft_100_close.values.tolist(),'var_stoch':df.var_stoch.values.tolist(), 'fft_100_low': df.fft_100_low.values.tolist(),'fft_100_high': df.fft_100_high.values.tolist(),'fft_100_open': df.fft_100_open.values.tolist(),'rsi_indicator':rsi_indicator,'stoch_indicator':stoch_indicator,'rsi':df['RSI'].values.tolist(),'ma20':df['ma20'].values.tolist(),'ma50':df['ma50'].values.tolist(),'26ema':df['26ema'].values.tolist(),'12ema':df['12ema'].values.tolist(),'upper_band':df['upper_band'].values.tolist(),'lower_band':df['lower_band'].values.tolist(),'ema_indicator':ema_indicator,'bollinger_indicator':bollinger_indicator,'var_ema':df.var_ema.values.tolist(),'var_bollinger':df.var_bollinger.values.tolist(),'%K':df['%K'].values.tolist(),'%D':df['%D'].values.tolist()}
		df = pd.DataFrame(df_dict)
		...
		name = []
		while i < len(index):
			name.append(trade_symbol)
			i += 1

		df_dict = {'name':name,'fft_20_close': df.fft_20_close.values.tolist(),'fft_20_open': df.fft_20_open.values.tolist(),'fft_20_low': df.fft_20_low.values.tolist(),'fft_20_high': df.fft_20_high.values.tolist(),'fft_100_close': df.fft_100_close.values.tolist(),'fft_100_low': df.fft_100_low.values.tolist(),'fft_100_high': df.fft_100_high.values.tolist(),'fft_100_open': df.fft_100_open.values.tolist(),'ma20':df['ma20'].values.tolist(),'ma50':df['ma50'].values.tolist(),'26ema':df['26ema'].values.tolist(),'12ema':df['12ema'].values.tolist(),'upper_band':df['upper_band'].values.tolist(),'lower_band':df['lower_band'].values.tolist(),'%K':df['%K'].values.tolist(),'%D':df['%D'].values.tolist(),'index':df.index.values.tolist(),'date':df.date.values.tolist(),'volume':volume,'label':label,'numberOfTrades':numberOfTrades,'close':df.close.values.tolist(),'fft_20_close': df.fft_20_close.values.tolist(),'fft_100_close':df.fft_100_close.values.tolist(),'var_ema':df['var_ema'].values.tolist(),'var_bollinger':df.var_bollinger.values.tolist(),'rsi_indicator':rsi_indicator,'stoch_indicator':stoch_indicator,'var_stoch': df['var_stoch'].values.tolist(),'RSI':rsi_list,'ema_indicator':ema_indicator,'bollinger_indicator':bollinger_indicator}
		df = pd.DataFrame(df_dict)
